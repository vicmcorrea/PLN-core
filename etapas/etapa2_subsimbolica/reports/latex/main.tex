...
Uma preocupação trazida da revisão da Etapa 1 foi deixar explícito o que foi feito pela equipe e o que veio de recursos externos. Nesta etapa, a equipe definiu o protocolo de comparação, preparou as versões tratadas do texto, treinou e avaliou os classificadores estatísticos, fez ajuste fino supervisionado dos transformers, investigou o vazamento de rótulo por sinais superficiais, adaptou a aplicação interativa para o modelo treinado e manteve o módulo de recomendação musical. Os recursos externos foram usados como base de dados, léxico, bibliotecas de aprendizado de máquina, modelos pré-treinados e links de reprodução. A Tabela~\ref{tab:autoria} separa esses papéis de forma resumida.
...
\addlinespace[0.25em]
Transformers ajustados & Ajuste fino supervisionado de DistilBERT, XLM-R e Albertina, seguido de avaliação nas mesmas condições de texto & Modelos pré-treinados \citep{sanh2019distilbert,conneau2020xlmr,rodrigues2023albertina} \\
\addlinespace[0.25em]
...
\addlinespace[0.3em]
Albertina 100M pt-BR & 3.000 tweets estratificados & Exemplo neural em português. Ajuste fino de desenvolvimento no texto bruto e sem emoticons e URLs \\
\addlinespace[0.3em]
