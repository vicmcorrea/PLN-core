...
- `leakage_diagnostics.yaml`: baselines cue-only e comparacoes raw vs texto tratado.
...
Para diagnosticos exploratorios contra mencoes, hashtags e fontes neutras
recorrentes, use `text_treatment=strip_social_source_cues` nos benchmarks ou
`stripped_treatment=strip_social_source_cues` no diagnostico de vazamento.
