...
Para executar o projeto, basta preparar o ambiente com o script \texttt{install.sh}. Depois disso, a execução pode ser feita com os comandos Python do próprio projeto.
